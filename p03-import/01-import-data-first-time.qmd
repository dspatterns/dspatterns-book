...
The data dictionary can be published in a Quarto document and placed somewhere prominant for you and others to read. This is great documentation to have when introducing others to the dataset or when your own recollection and understanding of the data has become shaky.
...
Of course, you can go much further with the data dictionary functionality in **pointblank**. More sections can be included and much more fine-grained information can be provided for columns.
