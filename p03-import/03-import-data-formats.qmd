...
- **readxl**: for the dataset we'll be using (`bakers`)
...
![The `us_cities` sheet in the example **Excel** file is a paragon of clean data as an input for the `read_excel()` function. This will make your life easier.](appendix-figures/86-importing-data-common-formats/04-figure-us-cities.png){#fig:us-cities}
...
![The `us_cities_messy` sheet in the example **Excel** file has a number of issues that require a much more sophisticated use of the `read_excel()` function.](appendix-figures/86-importing-data-common-formats/05-figure-us-cities-messy.png){#fig:us-cities-messy}
