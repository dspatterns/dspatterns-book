# A Closer Look at R Programming {#a-closer-look-at-r-programming}
...
knitr::include_graphics("figures/chapter_10/10-01-figure-multiplying_by_a_single_number.png")
```
...
knitr::include_graphics("figures/chapter_10/10-02-figure-multiplying_by_two_of_same_length.png")
```
...
knitr::include_graphics("figures/chapter_10/10-03-figure-multiplying_by_different_lengths.png")
```
...
```{r parts-of-a-function, echo = FALSE, fig.cap = '(ref:parts-of-a-function)'}
knitr::include_graphics("figures/chapter_10/10-05-figure-parts_of_a_function.png")
```
(ref:parts-of-a-function) The main parts of an **R** function are the name, the arguments, and the body. The statements typically involve values provided by the arguments.
