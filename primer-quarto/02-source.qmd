...
**Quarto** helps you create dynamic documents that combine code, rendered output (such as figures), and markdown-formatted text. It was developed by software engineers at RStudio, so it works well with the RStudio IDE
