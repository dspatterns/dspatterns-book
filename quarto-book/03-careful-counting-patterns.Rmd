...
Explore: glimpse/head/tail
Understand: tables + viz (distinct / count / geom_col)
Explain: nrow/ncol + combine with glue for inline code?
...
Sometimes, in the text of a document, you might want to describe your data. We can, for example, use `nrow()` to get the number of rows in the table like this `r knitr::inline_expr("`r nrow(bakers)`")`.
