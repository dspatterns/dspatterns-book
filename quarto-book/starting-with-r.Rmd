...
`subscript~2~ / superscript^2^`           subscript~2~ / superscript^2^
...
The skills we need to learn are closely tied to the packages that provide us with the toolsets for the task at hand. The diagram presented as @fig:workflow outlines the basic data analysis and reporting workflow. It is annotated with the packages that we'll learn and use in different chapters of this book.


![A typical workflow in a data analysis task or project. We begin by importing and tidying the data, enter into a cycle of transformation, visualization, and modeling, then we conclude by reporting our findings. All the while, we use our **R** programming skills along with functions from various packages.](figures/chapter_01/01-05-figure-workflow.png){#fig:workflow}
