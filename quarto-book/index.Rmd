...
We think you are familiar with a lot of the basics of using R, like installing it, using an IDE like RStudio, and packages. If you are not, go to appendix.

What we think you are here for: patterns + good practices :)
...
Explain: how do we take the answers and rationalize with the investigations. How to document to oneself, programmatic text for resilient reporting. (talking to yourself)

Share (Collaborate/Communicate): Making everything presentable and the outputs are in a format that allows for easy consumption and feedback. (sometimes reordering plots or tables to make them easier to interpret)
