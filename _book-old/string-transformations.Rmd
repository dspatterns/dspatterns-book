...
```{r regexplain-gadget, echo=FALSE, fig.cap='(ref:regexplain-gadget)'}
knitr::include_graphics("figures/chapter_11/11-01-figure-regexplain_gadget.png")
```
(ref:regexplain-gadget) The *RegExplain* Gadget as it appears in the **RStudio** Viewer. By interactively typing our regex into the field labeled `RegEx`, we can see what it matches on in the large text field below.
...
```{r regex-examples-1, echo=FALSE, fig.cap='(ref:regex-examples-1)'}
knitr::include_graphics("figures/chapter_11/11-02-figure-regex_examples_1.png")
```
(ref:regex-examples-1) Matching a simple regex pattern to the text and getting the first match.
...
```{r regex-examples-2, echo=FALSE, fig.cap='(ref:regex-examples-2)'}
knitr::include_graphics("figures/chapter_11/11-03-figure-regex_examples_2.png")
```
(ref:regex-examples-2) Using regex patterns with the dot, which unconditionally matches every character. In every case here, the first match is shown.
...
```{r regex-examples-3, echo=FALSE, fig.cap='(ref:regex-examples-3)'}
knitr::include_graphics("figures/chapter_11/11-04-figure-regex_examples_3.png")
```
(ref:regex-examples-3) Using regex patterns with the escaped form of the dot results in matches involving the period character.
...
```{r regex-examples-4, echo=FALSE, fig.cap='(ref:regex-examples-4)'}
knitr::include_graphics("figures/chapter_11/11-05-figure-regex_examples_4.png")
```
(ref:regex-examples-4) Using regex patterns with character sets to match similar words. The pattern in the first example will match two words (even though only the first match is shown).
...
```{r regex-examples-5, echo=FALSE, fig.cap='(ref:regex-examples-5)'}
knitr::include_graphics("figures/chapter_11/11-06-figure-regex_examples_5.png")
```
(ref:regex-examples-5) Using regex patterns with character classes to match on classes of characters.
...
```{r regex-examples-6, echo=FALSE, fig.cap='(ref:regex-examples-6)'}
knitr::include_graphics("figures/chapter_11/11-07-figure-regex_examples_6.png")
```
(ref:regex-examples-6) The difference between `*` and `*?` during repetition means the difference between greedy and lazy matching. Repetition with `\\w{5}` is exact, matching 5 word characters.
