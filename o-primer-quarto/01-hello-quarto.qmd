...
![](../appendix-figures/82-starting-with-r/figure-rmarkdown-annotation.png)
...
![The rendered HTML document based on the **Quarto** document. The preview window provides a way to easily look over the output initiated by a *Render*.](../appendix-figures/82-starting-with-r/figure-rmarkdown-html-output.png)
