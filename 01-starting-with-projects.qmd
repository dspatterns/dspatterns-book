...
-   Store all your projects inside a dedicated folder, we like `Documents/ds-projects` (you can use `Documents/ds-scratch` for projects you think you won't need to save)

-   Use kebab case when naming files and folders.

-   Start new Quarto projects using the RStudio New Project Wizard.
