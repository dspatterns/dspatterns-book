...
In the many examples that follow, we'll use datasets provided in the **dspatterns** package. One of them was used before (`nycweather`) but the `imdb` and `pitchfork` datasets are new in this chapter and great fun to use! You can find out more about them within **R** by visiting their documentation pages (`help(imdb)` or `help(pitchfork)`).
