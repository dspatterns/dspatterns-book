...
- Introducing **Quarto** as a way to run **R** code
...
![The **RStudio Desktop** environment with an **Quarto** file in focus in top-left (the source pane) and the **R** console occupying the bottom-left.](appendix-figures/82-starting-with-r/figure-rstudio-desktop-env.png){#fig:rstudio-desktop-env}
...
## Using **Quarto** for Reproducible Reporting
...
- We will use **RStudio** to work with **R** in these Appendices
- **Quarto** is a way to run **R** code and create a report from a combination of prose and code
