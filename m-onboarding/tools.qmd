...
![The **RStudio IDE** environment with an **Quarto** file in focus in top-left (the source pane) and the R console occupying the bottom-left.](img/rstudio-desktop-environment.png){#fig:rstudio-desktop-env}
