...
![](img/r-programming-01-multiplying_by_a_single_number.png){#fig:multiplying-by-a-single-number}
...
![](img/r-programming-02-multiplying_by_two_of_same_length.png){#fig:multiplying-by-two-of-same-length}
...
![](img/r-programming-03-multiplying_by_different_lengths.png){#fig:multiplying-by-different-lengths}
...
![Two approaches to an analysis involving repetitive data. The first doesn't use a generalized function but have to produce a similar analysis script for each dataset. The second approach uses a single function within an **R Markdown** document so that the results can be rendered to a document that can be shared.](img/r-programming-04-reason_why_to_write_functions.png){#fig:reason-why-to-write-functions}
...
![The main parts of an R function are the name, the arguments, and the body. The statements typically involve values provided by the arguments.](img/r-programming-05-parts_of_a_function.png){#fig:parts-of-a-function}
